...
@section('content')
    ...
    <section class="w-4/6 m-auto">
        <h2 class="text-teal-500 text-center text-3xl font-semibold mt-20 mb-5">¿Quieres devolver la película de <span class="text-white">{{ $PeliculaAlquilada->pelicula->titulo }}</span>?</h2>
